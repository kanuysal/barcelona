...
function S(t, e, n) {
  if (D(n)) n.forEach((i) => S(t, e, i));
    ...
    const i = ft(t, e);
    w.test(n) ? t.setProperty($(i), n.replace(w, ""), "important") : (t[i] = n);
  }
}
...
var Lt =
  ...
  async (e, n, i, { client: s }) => {
    ...
    const c = s !== "only",
      f = c ? Et : Ct;
    let a = O.get(t);
    if (a) ((a.props = n), (a.slots = r), a.component.$forceUpdate());
    else {
      a = { props: n, slots: r };
      const u = f({
        name: o,
        render() {
          let p = h(e, a.props, a.slots);
          return ((a.component = this), Nt(e.setup) && (p = h(V, null, p)), p);
        },
      });
