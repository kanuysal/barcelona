...
function M(e, t) {
  ...
  if (
    ...
    i instanceof Element && e.currentTarget instanceof Node)
  ) {
    const s = i.closest(t);
...
function V(e, t) {
  ...
  return Math.max(...t.map((i, s) => I(i) + I(e[s])));
}
function I(e) {
...
async function Y(e, t = {}) {
  ...
  try {
    ...
    if (
      ...
      e.animation.name && this.classes.add(`to-${N(e.animation.name)}`),
    ...
    ((e.state = 9),
      ...
      (this.options.skipPopStateHandling = () => (
        window.location.assign(e.to.url + e.to.hash),
        !0
      )),
      window.history.back());
  } finally {
    ...
    return (
      ...
      s &&
        ...
        (o = this.hooks.callSync(
          ...
          { options: t },
          (r, { options: a }) => (
            window.scrollTo(p({ top: 0, left: 0 }, a)),
            !0
          ),
        )),
      o
    ...
    (this.isSameResolvedUrl(S(), i) ||
      ...
      await this.hooks.call("content:replace", e, { page: t }, (s, {}) => {
        ...
        s.animation.animate &&
          ...
          s.animation.name && this.classes.add(`to-${N(s.animation.name)}`));
      }),
...
export { ut as _, v as l, S as n, ct as v };
